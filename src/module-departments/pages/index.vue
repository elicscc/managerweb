                    ...
                    <div class="fr">
                      <span class="treeRinfo">
                        <div class="treeRinfo">
                          ...
                          <span>在职  <em class="colGreen" title="在职人数">1</em>&nbsp;&nbsp;(<em class="colGreen" title="正式员工">1</em>&nbsp;/&nbsp;<em class="colRed" title="非正式员工">0</em>)</span>
                        </div>
                        <div class="treeRinfo">
                         ...
                         <div class="fr">
                          <span class="treeRinfo">
                            <div class="treeRinfo">
                              ...
                              <span>在职  <em class="colGreen" title="在职人数">200</em>&nbsp;&nbsp;(<em class="colGreen" title="正式员工">150</em>&nbsp;/&nbsp;<em class="colRed" title="非正式员工">50</em>)</span>
                            </div>
                            <div class="treeRinfo">
                              <el-dropdown class="item">
                                <span class="el-dropdown-link">
    ...
    handleDelete(id) {
       this.$confirm('是否删除此条记录?', '提示', {
          ...
          type: 'warning'
                 ...
                 this.$message({message:"拒绝！",type:"error"});
        })
    },
