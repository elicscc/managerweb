  ...
  <div class="dashboard-container">
    <el-card class="sales-card">
      <div class="clearfix">
        <div class='fl headL'>
          <div class="headImg">
            <img src="https://cdn.jsdelivr.net/gh/elicscc/ihrmweb/src/assets/head.jpg"/>
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，HR 专员，祝你开心每一天！</p>
            <p class="lastChild">HR 专员  |  XXX公司-总部-人力资源中心-招聘专员</p>
          </div>
        </div>
        <div class="fr">
                ...
                <ul class="noticeList">
                  <li>
                    <div class="item">
                        ...
                        <div>
                          <p><span class="col">张三</span> 发布了 第二十期“XX讲堂”互动讨论获奖名单公布</p>
